...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		Log.i(TAG, screenResolution.x+"Screen resolution: " + screenResolution);
		if (width>height){
	...
	Point getScreenResolution() {
		Log.i("TAG","数据screenResolution："+screenResolution);
		if (screenResolution==null){
			screenResolution = new Point(1080, 1920);
		}
		Log.i("TAG","数据2screenResolution："+screenResolution);
